...
let position = (num1, num2) => {
    console.log(num1, num2);
};
position(5, 6);
function shift_work(val1, val2, val3) {
    console.log(val1);
    console.log(val2);
    console.log(val3);
}
shift_work('cloths', 'pencil', 2300);
let count = (val1, val2, name = "bilal") => {
    console.log(val1);
    console.log(val2);
    console.log(name);
};
count(4, 6, 'hooriya');
let value = (val3, val4, name = "bilal") => {
    console.log(val3);
    console.log(val4);
    console.log(name);
};
value(4, 6);
function value1(num11, num22) {
    return num11 - num22;
}
let result1 = value1(12, 16);
console.log(result1);
function value12(num11, num22) {
    return num11 * num22;
}
let result2 = value12(12, 16);
console.log(result2);
function value2(num11, num22) {
    return num11 / num22;
}
let result3 = value2(12, 16);
console.log(result3);
function value132(num11, num22) {
    return num11 / num22;
}
